...
//******************************************************************************************************************************************************************************************
        ...
        this.lago1 = new C_Lago(gl, 0, 0, -4, 4, 5, 5, 90);
        this.parqueadero1 = new C_Parqueadero(gl, 19, 0, -14, 3, 3, 3, 0);
        this.cancha1 = new C_Canchas(gl, -16f, 0.0f, 11, 8, 15, 8, 90);
        this.parque_niño1 = new C_Parque_Niños(gl, 15, 0.05f, 10, 7, 7, 7, 0);
        this.jardin1 = new C_Jardin_Chino(gl, 0, 0.1f, -16, 8, 4, 8, 0);
        this.Parq_Perritos1 = new C_Parque_Perritos(gl, -17f, 0.1f, -10, 5, 5, 5, 0);
        this.caminos1 = new C_Caminos(gl, 0, 0f, 0, 24, 19, 19, 0);
        this.arboles1 = new C_Arboles(gl, 0, 0, 0, 25, 25, 20, false);
...
//        this.bici = new E_Bicicleta(gl, 0, 0, 0, 5, 5, 5, 0, 0, 0, 1, 0, 1);
        this.persona = new C_Personas(gl, 0, 0, 0, 20, 2.5f, 20);
//******************************************************************************************************************************************************************************************
